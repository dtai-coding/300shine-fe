...
export function AppointmentManagerItem({
  appointment,
  reloadCallBack,
}: {
    ...
    <Box border={1} borderRadius={2} p={2} mb={2}>
              ...
              <Box display="flex" justifyContent="space-between" alignItems="center">
                ...
                {/* {detail.status === 'Pending' && (
                  <Button
                    ...
                    color="primary"
                    sx={{ mt: 2 }}
                    onClick={() => openConfirmDialogForDetail(detail.appointmentId, detail.status)}
                  >
                    Accept
                  </Button>
                )}
      ...
      <Dialog open={openConfirmDialog} onClose={() => setOpenConfirmDialog(false)}>
        ...
        <DialogActions>
          ...
          <Button
            onClick={
              selectedDetailId && process === 'Pending' ? handleAcceptClick : handleCompleteClick
            }
            color="primary"
          >
            Confirm
